...
// class MypageTerms extends ConsumerWidget {
//   const MypageTerms({super.key});

//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     final agree = ref.watch(termsAgreeProvider);
//     final disagree = ref.watch(termsDisagreeProvider);
//     return Scaffold(
//       appBar: AppBar(
...
//                   SLCheckbox(
//                       onChange: (value) {
//                         ref.read(termsAgreeProvider.notifier).state = value;
//                         ref.read(termsDisagreeProvider.notifier).state = !value;
//                       },
//                       value: agree),
//                   SizedBox(
//                     width: 10,
