...
class ComSearchPage extends ConsumerStatefulWidget {
  const ComSearchPage({super.key});

  @override
  ConsumerState<ComSearchPage> createState() => _ComSearchPageState();
}

class _ComSearchPageState extends ConsumerState<ComSearchPage> {
